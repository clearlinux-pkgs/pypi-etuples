...
Version  : 0.3.6
Release  : 11
URL      : https://files.pythonhosted.org/packages/88/8a/1dad8a0e17a60547056cefba4931f4ffb121bc0f567a3ea110d9f1b42c21/etuples-0.3.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/88/8a/1dad8a0e17a60547056cefba4931f4ffb121bc0f567a3ea110d9f1b42c21/etuples-0.3.6.tar.gz
...
%prep
%setup -q -n etuples-0.3.6
cd %{_builddir}/etuples-0.3.6
pushd ..
cp -a etuples-0.3.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662135282
