...
Source0  : https://files.pythonhosted.org/packages/22/60/134940a09d03786ad7267e53458a749e2f4bfaf1efd672363e87a4a13561/etuples-0.3.9.tar.gz
...
%prep
%setup -q -n etuples-0.3.9
cd %{_builddir}/etuples-0.3.9
pushd ..
cp -a etuples-0.3.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684608379
